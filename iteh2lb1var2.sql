...
--
-- Хост: localhost:3306
-- Время создания: Май 25 2022 г., 13:38
...
(8, 'q', 2, 'e', 'r', 'Practical'),
(9, 'q', 2, 'e', 'r', 'Practical'),
(10, 'q', 2, 'e', 'r', 'Practical'),
(11, 'test1', 34, 'test2', 'test3', 'Practical'),
(12, 'monday', 2, '65e', 'KSX', 'Practical'),
(13, 'tuesday', 3, '654t', 'Computer Techno', 'Practical'),
(14, 'monday', 1, '34', 'itech', 'Practical');
...
--
ALTER TABLE `lesson`
  MODIFY `ID_Lesson` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
COMMIT;
